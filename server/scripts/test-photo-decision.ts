...
const PRIMARY_BBOX: NormalizedBoundingBox = {
  x: 0.12,
  y: 0.08,
  width: 0.42,
  height: 0.55,
...
const scenarios: Scenario[] = [
  ...
  {
    name: '5c. несколько вещей без boundingBox',
    signals: {
      clothingCount: 2,
      confidence: 0.82,
      background: 'moderate',
  ...
  {
    name: '5d. несколько вещей с invalid boundingBox',
    signals: {
      clothingCount: 2,
      confidence: 0.82,
      background: 'moderate',
      ...
      itemTooSmallOrObscured: false,
      item: SAMPLE_ITEM,
      boundingBox: { x: 0.2, y: 0.2, width: 0.9, height: 0.5 },
    },
    expectedAccepted: false,
    expectedReason: PHOTO_REJECT_REASONS.MULTIPLE_ITEMS,
  },
