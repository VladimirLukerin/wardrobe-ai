...
import { getAiRateLimitUserMessage, isAnyAiRateLimitError } from '@/utils/ai-rate-limit-error';
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (error instanceof AccountApiError) {
        setSubmitError(isAnyAiRateLimitError(error) ? getAiRateLimitUserMessage(error) : error.message);
        return;
      }
